...
public class ConfigurationKeys {
        ...
        public static final ConfigurationKey<List<String>> ALLOWED_COMMANDS_WHILE_UNAUTHORIZED = new ConfigurationKey<>(
                        ...
                        "Commands that are allowed while the user is not authorized. "
                                        + "Leave empty to disallow all commands (recommended for web-auth).",
        ...
        public static final ConfigurationKey<String> PROFILE_CONFLICT_RESOLUTION_STRATEGY = new ConfigurationKey<>(
                        ...
                        """
                                        ...
                                        """,
                        (helper, key) -> ProfileConflictResolutionStrategy.valueOf(
        ...
        public static final ConfigurationKey<?> WEB_SERVER = ConfigurationKey.getComment(
                        "web-server",
                        """
                                        Configuration for the built-in web server used for authentication.
                                        """);

        public static final ConfigurationKey<Integer> WEB_PORT = new ConfigurationKey<>(
                        "web-server.port",
                        8080,
                        "The port for the embedded web server.",
                        ConfigurateHelper::getInt);

        public static final ConfigurationKey<String> WEB_PUBLIC_URL = new ConfigurationKey<>(
                        "web-server.public-url",
                        "http://localhost:8080",
                        "The public URL for the authentication page.",
                        ConfigurateHelper::getString);

        public static final ConfigurationKey<List<String>> ADMIN_LIST = new ConfigurationKey<>(
                        "admin-list",
                        List.of(),
